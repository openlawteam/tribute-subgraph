...
# local: Deploys the subgraphs to your local Graph Node
# host: Deploys the subgraph to The Graph hosted service
# network: Deploys subgraph to The Graph decentralized service
...
# to the graph node type: host.
GRAPH_ACCESS_TOKEN=...

# The Graph API Deployment Key that will be used to deploy the Subgraph
# to the decentralized graph node type: network.
